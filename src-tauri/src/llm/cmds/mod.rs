...
#[allow(unused_imports)]
pub use chat::{
    archive_chat_session, delete_chat_session, get_last_chat_session, get_session_params,
    list_archived_chat_sessions, list_chat_sessions, load_chat_session, new_chat_session,
    rename_chat_session, save_chat_message, save_chat_tool_calls, set_session_params,
    unarchive_chat_session, ChatSessionResponse,
};
pub use downloads::{
    cancel_llm_download, cancel_llm_download_with_app, delete_llm_model, download_llm_model,
    open_downloads_window, pause_llm_download, resume_llm_download,
};
#[allow(unused_imports)]
...
pub(super) fn save_catalog_locked(
    _app: &AppHandle,
    skill_dir: &std::path::Path,
    llm: &crate::state::LlmState,
) {
...
pub(super) fn infer_quant(filename: &str) -> String {
    ...
    let quants = [
        "IQ4_NL", "IQ4_XS", "IQ3_XXS", "IQ3_XS", "IQ3_M", "IQ3_S", "IQ2_XXS", "IQ2_XS", "IQ2_M",
        "IQ2_S", "Q6_K_L", "Q6_K", "Q5_K_L", "Q5_K_M", "Q5_K_S", "Q4_K_L", "Q4_K_M", "Q4_K_S",
        "Q4_0", "Q4_1", "Q3_K_XL", "Q3_K_L", "Q3_K_M", "Q3_K_S", "Q2_K_L", "Q2_K", "Q8_0", "Q8_1",
        "BF16", "F16", "F32",
    ];
    for q in &quants {
        if upper.contains(q) {
...
pub(super) fn ensure_catalog_entry(
    ...
    let entry = super::catalog::LlmModelEntry {
        ...
        tags: if is_mmproj {
            vec!["vision".into(), "multimodal".into()]
        } else {
            vec!["chat".into()]
        },
        is_mmproj,
