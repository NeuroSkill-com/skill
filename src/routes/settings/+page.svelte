...
<script lang="ts">
  ...
  type Tab = "goals" | "devices" | "sleep" | "calibration" | "embeddings" | "hooks" | "appearance" | "settings" | "shortcuts" | "model" | "umap" | "updates" | "tts" | "permissions" | "llm" | "tools" | "screenshots";
  let tab = $state<Tab>("goals");

  const TAB_IDS: Tab[] = ["goals", "devices", "sleep", "calibration", "tts", "llm", "tools", "model", "embeddings", "screenshots", "hooks", "appearance", "settings", "shortcuts", "umap", "updates", "permissions"];
