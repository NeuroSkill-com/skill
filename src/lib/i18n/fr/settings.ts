...
const settings: Record<string, string> = {
  ...
  "activity.todaySummary": "Activité du jour",
  "activity.filesWorked": "Fichiers",
  "activity.edits": "Modifications",
  "activity.linesChanged": "Lignes modifiées",
  "activity.projects": "Projets",
  "activity.noData": "Aucune activité de fichier enregistrée aujourd'hui.",
  "activity.productivityScore": "Score de productivité",
  "activity.editVelocity": "Vitesse d'édition",
  "activity.deepWork": "Travail en profondeur",
  "activity.contextStability": "Stabilité du contexte",
  "activity.eegFocus": "Concentration EEG",
  "activity.hourlyHeatmap": "Activité horaire",
  "activity.topFiles": "Fichiers principaux",
  "activity.topProjects": "Projets principaux",
  "activity.last7days": "7 derniers jours",
  "activity.languages": "Langages",
  "activity.focusSessions": "Sessions de concentration",
  "activity.filesShort": "fichiers",
  "activity.meetings": "Réunions",
  "activity.meetingOngoing": "en cours",
  "activity.staleFiles": "Fichiers inactifs",
  "activity.staleAgo": "passé",
  "activity.replayLoading": "Chargement des détails de la session...",
  "activity.eegOverlay": "Focus EEG",
  "activity.noFilesInSession": "Aucune activité fichier enregistrée pendant cette session.",
  "activity.weeklyReport": "Rapport hebdomadaire",
  ...
  "settingsTabs.activity": "Activité",
  ...
  "settings.supportedDevices.instruction.oura1":
    "Obtenir un jeton d'accès personnel depuis cloud.ouraring.com/personal-access-tokens.",
  "settings.supportedDevices.instruction.oura2": "Ouvrir API appareil → Oura Ring, coller le jeton et enregistrer.",
  "settings.supportedDevices.instruction.oura3":
    "Cliquer sur Synchroniser pour récupérer les données de sommeil, activité, préparation, fréquence cardiaque et SpO2.",
  ...
  "daemon.stateConnecting": "connexion",
  "daemon.stateError": "erreur",
  "daemon.stateDisconnected": "hors ligne",
  "daemon.titlePrefix": "Moteur",
  "daemon.notConnectedWarning": "Le moteur n'est pas connecté. Les données de calibration ne seront pas enregistrées.",
  "daemon.auth": "auth ✓",
  "daemon.protocol": "protocole",
  ...
  "daemon.restart": "Redémarrer",
  "daemon.restartTitle": "Cliquer pour redémarrer le moteur",
  "daemon.stateChangeConnected": "Moteur reconnecté.",
  "daemon.stateChangeDisconnected": "Moteur déconnecté — reconnexion…",
  "daemon.popoverTitle": "État du Moteur",
  "daemon.uptime": "Disponibilité",
  "daemon.version": "Version",
  "daemon.latency": "Latence",
  "daemon.wsClients": "Clients WS",
  "daemon.forceRestart": "Forcer le redémarrage",
  "daemon.streaming": "diffusion",
  "daemon.idle": "inactif",
  ...
  "settingsTabs.clients": "Applications clientes",
  "settingsTabs.terminal": "Console",
  "settingsTabs.validation": "Vérification",
  "settings.group.signal": "Signaux",
  "settings.group.intelligence": "IA",
  "settings.group.capture": "Capture et confidentialité",
  "settings.group.automation": "Automatisation",
  "settings.group.app": "App",
  "settings.group.advanced": "Avancé",
  "settings.group.showAdvanced": "Afficher l’avancé",
  "settings.group.hideAdvanced": "Masquer l’avancé",
};
