...
const help: Record<string, string> = {
  ...
  "helpOld.hooksDesc":
    "Les hooks tournent en arrière-plan : correspondance floue des mots-clés → expansion par voisins textuels → vérification de distance EEG. En cas de match, un événement hook est diffusé et une notification est affichée.",
  ...
  "helpDash.trayAmberDesc": "Recherche d'un appareil BCI ou tentative de connexion.",
  ...
  "helpOld.trayIconDesc":
    "L'icône de la barre de menus change de couleur et de forme pour refléter l'état de connexion actuel.",
  ...
  "helpOld.btLifecycleDesc":
    "{app} surveille l'état Bluetooth en temps réel via CoreBluetooth (macOS) ou BlueZ (Linux). Pas de délai de polling.",
  ...
  "helpOld.btStep5Desc":
    "Même boucle de réessai que la reconnexion automatique. Réessaie toutes les 3 secondes jusqu'à ce que l'appareil soit trouvé.",
  ...
  "helpOld.wsDesc":
    "{app} diffuse des métriques EEG dérivées (~4 Hz) et l'état de l'appareil (~1 Hz) via un serveur WebSocket local. Les échantillons bruts ne sont pas diffusés.",
  ...
  "helpFaq.q44": "Puis-je utiliser deux appareils BCI simultanément ?",
  "helpFaq.a44":
