...
const onboarding: Record<string, string> = {
  ...
  "onboarding.welcomeBody":       "{app} enregistre, analyse et indexe vos données EEG depuis tout appareil BCI pris en charge. Configurons tout en quelques étapes rapides.",
  ...
  "onboarding.bluetoothBody":     "Allumez votre appareil BCI et portez-le. {app} recherchera automatiquement les appareils à proximité.",
  ...
  "onboarding.btStep1":           "Allumez votre appareil BCI (maintenez le bouton, basculez l'interrupteur ou appuyez sur le bouton selon votre casque).",
