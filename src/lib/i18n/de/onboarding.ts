...
const onboarding: Record<string, string> = {
  ...
  "onboarding.bluetoothBody":     "Schalte dein BCI-Gerät ein und setze es auf. {app} sucht automatisch nach Geräten in der Nähe.",
  ...
  "onboarding.btStep1":           "Schalte dein BCI-Gerät ein (Ein-/Aus-Knopf halten, Schalter umlegen oder Taste drücken, je nach Headset).",
