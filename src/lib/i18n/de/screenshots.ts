...
const screenshots: Record<string, string> = {
  ...
  "screenshots.backendRlx": "RLX (lokal, safetensors)",
  ...
  "screenshots.ocrEngineOcrs": "rlx-ocr — lokale CPU / GPU (plattformübergreifend)",
  "screenshots.ocrAppleVisionHint": "⚡ Apple Vision läuft auf GPU/ANE und ist schneller als rlx-ocr auf macOS",
  ...
  "screenshots.ocrDesc":
    "Text wird aus jedem Screenshot in voller Auflösung vor der Verkleinerung mit der rlx-ocr-Engine extrahiert. Der extrahierte Text wird mit nomic-embed-text-v1.5 eingebettet und in einem separaten HNSW-Index für die semantische Textsuche indiziert. OCR-Modelle sind gebündelt und laufen offline — kein Download erforderlich.",
