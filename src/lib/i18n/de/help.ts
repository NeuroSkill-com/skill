...
const help: Record<string, string> = {
  ...
  "helpOld.hooksDesc":
    "Hooks laufen im Hintergrund: unscharfer Keyword-Match → Text-Nachbarsuche → EEG-Distanzprüfung. Bei Treffer wird ein Hook-Event gesendet und eine Benachrichtigung angezeigt.",
  ...
  "helpOld.trayIconDesc":
    "Das Menüleisten-Icon ändert Farbe und Form, um den aktuellen Verbindungsstatus auf einen Blick anzuzeigen.",
  ...
  "helpOld.btLifecycleDesc":
    "{app} überwacht den Bluetooth-Status in Echtzeit über CoreBluetooth (macOS) oder BlueZ (Linux). Keine Polling-Verzögerung — Statusänderungen werden innerhalb einer Sekunde reflektiert.",
  ...
  "helpOld.btStep5Desc":
    "Gleiche Wiederholungsschleife wie bei der automatischen Wiederverbindung. Wiederholt alle 3 Sekunden bis das Gerät gefunden wird.",
  ...
  "helpOld.wsDesc":
    "{app} streamt abgeleitete EEG-Metriken (~4 Hz) und Gerätestatus (~1 Hz) über einen lokalen WebSocket-Server. Roh-EEG/PPG/IMU werden nicht übertragen.",
