...
const settings: Record<string, string> = {
  ...
  "activity.todaySummary": "Heutige Aktivität",
  "activity.filesWorked": "Dateien",
  "activity.edits": "Bearbeitungen",
  "activity.linesChanged": "Geänderte Zeilen",
  "activity.projects": "Projekte",
  "activity.noData": "Heute wurde keine Dateiaktivität aufgezeichnet.",
  "activity.productivityScore": "Produktivitätswert",
  "activity.editVelocity": "Bearbeitungsgeschwindigkeit",
  "activity.deepWork": "Tiefenarbeit",
  "activity.contextStability": "Kontextstabilität",
  "activity.eegFocus": "EEG-Fokus",
  "activity.hourlyHeatmap": "Stündliche Aktivität",
  "activity.topFiles": "Top-Dateien",
  "activity.topProjects": "Top-Projekte",
  "activity.last7days": "Letzte 7 Tage",
  "activity.languages": "Sprachen",
  "activity.focusSessions": "Fokus-Sitzungen",
  "activity.filesShort": "Dateien",
  "activity.meetings": "Besprechungen",
  "activity.meetingOngoing": "laufend",
  "activity.staleFiles": "Inaktive Dateien",
  "activity.staleAgo": "her",
  "activity.replayLoading": "Sitzungsdetails werden geladen...",
  "activity.eegOverlay": "EEG-Fokus",
  "activity.noFilesInSession": "Keine Dateiaktivität in dieser Sitzung aufgezeichnet.",
  "activity.weeklyReport": "Wochenbericht",
  ...
  "settingsTabs.activity": "Aktivität",
  ...
  "settings.supportedDevices.instruction.awear1":
    "Schalten Sie Ihr AWEAR-EEG-Gerät ein und stellen Sie sicher, dass Bluetooth auf Ihrem Computer aktiviert ist.",
  "settings.supportedDevices.instruction.awear2":
    "Suchen Sie nach BLE-Geräten und verbinden Sie sich mit AWEAR. Die Authentifizierung erfolgt automatisch über HMAC-SHA256.",
  ...
  "settings.supportedDevices.instruction.brainbit1":
    "Schalten Sie das BrainBit-Stirnband ein. Stellen Sie sicher, dass die NeuroSDK2-Bibliothek für Ihre Plattform installiert ist.",
  "settings.supportedDevices.instruction.brainbit2":
    "Der Scanner erkennt BrainBit-Geräte automatisch über BLE. Tippen Sie auf das Gerät zum Koppeln.",
  "settings.supportedDevices.company.brainmaster": "BrainMaster Technologies",
  "settings.supportedDevices.device.brainmasterAtlantis4": "Atlantis 4×4 (4-Kanal)",
  "settings.supportedDevices.device.brainmasterDiscovery": "Discovery (24-Kanal)",
  "settings.supportedDevices.device.brainmasterFreedom": "Freedom (24-Kanal kabellos)",
  "settings.supportedDevices.instruction.brainmaster1":
    "USB-Seriell-Dongle anschließen und BrainMaster-Verstärker einschalten (57600 Baud, FTDI).",
  "settings.supportedDevices.instruction.brainmaster2":
    "Boardmodell in OpenBCI-Einstellungen auswählen. Port wird automatisch erkannt oder manuell gesetzt.",
  ...
  "settings.supportedDevices.instruction.gtec1":
    "Stellen Sie sicher, dass die Unicorn-API-Bibliothek auf Ihrem System installiert ist.",
  "settings.supportedDevices.instruction.gtec2":
    "Unicorn-Headset einschalten und in der Nähe des Computers halten. Der Scanner erkennt es automatisch über BLE.",
  "settings.supportedDevices.company.neurofield": "Neurofield Inc",
  "settings.supportedDevices.device.neurofieldQ21": "Q21 (20-Kanal)",
  "settings.supportedDevices.instruction.neurofield1":
    "PEAK PCAN-USB-Adapter anschließen und den Q21-Verstärker über CAN-Bus verbinden.",
  "settings.supportedDevices.instruction.neurofield2":
    "PCAN-Basic-Treiber für Ihre Plattform installieren. Der Scanner erkennt den Q21 automatisch.",
  ...
  "settings.supportedDevices.instruction.neurosky1":
    "Verbinden Sie den NeuroSky-USB/Bluetooth-Serielladapter und schalten Sie das Headset ein.",
  "settings.supportedDevices.instruction.neurosky2":
    "Verwenden Sie das Ziel 'neurosky' (oder 'neurosky:<serial-port>') für die Verbindung.",
  ...
  "settings.supportedDevices.instruction.neurosity1":
    "Setzen Sie SKILL_NEUROSITY_EMAIL, SKILL_NEUROSITY_PASSWORD und SKILL_NEUROSITY_DEVICE_ID.",
  "settings.supportedDevices.instruction.neurosity2":
    "Verwenden Sie das Ziel 'neurosity:<device-id>' für die Verbindung über die Neurosity-Cloud-API.",
  ...
  "settings.supportedDevices.instruction.brainvision1":
    "Starten Sie Recorder/Remote Data Access und stellen Sie einen RDA-TCP-Stream bereit (Standard 127.0.0.1:51244).",
  "settings.supportedDevices.instruction.brainvision2":
    "Verwenden Sie das Ziel 'brainvision:<host>:<port>' (oder 'brainvision') für die Verbindung.",
  ...
  "settings.deviceApi.neurosityDesc": "Zugangsdaten und Geräte-ID für Neurosity Crown/Notion Cloud-Streaming.",
  "settings.deviceApi.neurosityEmail": "E-Mail",
  "settings.deviceApi.neurosityPassword": "Passwort",
  "settings.deviceApi.neurosityDeviceId": "Geräte-ID",
  "settings.deviceApi.brainmasterTitle": "BrainMaster",
  "settings.deviceApi.brainmasterDesc": "Wählen Sie das BrainMaster-Modell für den Connector.",
  "settings.deviceApi.brainmasterModel": "Modell",
  ...
  "daemon.connection": "Engine",
  "daemon.unreachable": "Engine nicht erreichbar: {error}. Einige Funktionen sind möglicherweise nicht verfügbar.",
  "daemon.authFailed": "Engine-Authentifizierung fehlgeschlagen.",
  "daemon.wsError": "Engine WebSocket-Verbindung verloren.",
  "daemon.stateConnected": "engine",
  "daemon.stateConnecting": "verbinde",
  "daemon.stateError": "fehler",
  "daemon.stateDisconnected": "offline",
  "daemon.titlePrefix": "Engine",
  "daemon.notConnectedWarning": "Engine ist nicht verbunden. Kalibrierungsdaten werden nicht aufgezeichnet.",
  "daemon.auth": "auth ✓",
  "daemon.protocol": "protokoll",
  "daemon.launchingIn": "offline · Start in {secs}s",
  "daemon.starting": "wird gestartet…",
  "daemon.launchNow": "Klicken zum sofortigen Starten",
  "daemon.restart": "Neustart",
  "daemon.restartTitle": "Klicken um die Engine neu zu starten",
  "daemon.stateChangeConnected": "Engine wieder verbunden.",
  "daemon.stateChangeDisconnected": "Engine getrennt — Verbindung wird wiederhergestellt…",
  "daemon.popoverTitle": "Engine-Status",
  "daemon.uptime": "Betriebszeit",
  "daemon.version": "Version",
  "daemon.latency": "Latenz",
  "daemon.wsClients": "WS-Clients",
  "daemon.forceRestart": "Neustart erzwingen",
  ...
  "daemonActivity.title": "Hintergrundaktivität des Daemons",
  "daemonActivity.intro":
    "Wiederkehrende Aufgaben, die der Daemon im Hintergrund ausführt — was sie tun, wozu sie da sind und wie oft sie laufen. Deaktiviere ungenutzte Tracker, um CPU-Last zu sparen.",
  "daemonActivity.loading": "Wird geladen …",
  "daemonActivity.running": "aktiv",
  "daemonActivity.idle": "inaktiv",
  "daemonActivity.eventDriven": "ereignisbasiert",
  "daemonActivity.whyPrefix": "Warum:",
  "daemonActivity.costLow": "geringe Last",
  "daemonActivity.costMedium": "mittlere Last",
  "daemonActivity.costHigh": "hohe Last",
  "daemonActivity.never": "noch nicht ausgeführt",
  "daemonActivity.lastRanSecondsAgo": "vor {n} s",
  "daemonActivity.lastRanMinutesAgo": "vor {n} min",
  "daemonActivity.lastRanHoursAgo": "vor {n} h",
  ...
  "settings.group.showAdvanced": "Erweitert anzeigen",
  "settings.group.hideAdvanced": "Erweitert ausblenden",
};
