...
const settings: Record<string, string> = {
  ...
  "activity.todaySummary": "今日のアクティビティ",
  "activity.filesWorked": "ファイル",
  "activity.edits": "編集",
  "activity.linesChanged": "変更行数",
  "activity.projects": "プロジェクト",
  "activity.noData": "今日のファイルアクティビティは記録されていません。",
  "activity.productivityScore": "生産性スコア",
  "activity.editVelocity": "編集速度",
  "activity.deepWork": "ディープワーク",
  "activity.contextStability": "コンテキスト安定性",
  "activity.eegFocus": "EEG集中度",
  "activity.hourlyHeatmap": "時間別アクティビティ",
  "activity.topFiles": "トップファイル",
  "activity.topProjects": "トッププロジェクト",
  "activity.last7days": "過去7日間",
  "activity.languages": "言語",
  "activity.focusSessions": "集中セッション",
  "activity.filesShort": "ファイル",
  "activity.meetings": "ミーティング",
  ...
  "daemon.connection": "エンジン",
  "daemon.unreachable": "エンジンに接続できません：{error}。一部の機能が利用できない場合があります。",
  "daemon.authFailed": "エンジン認証に失敗しました。トークンが更新された可能性があります。",
  "daemon.wsError": "エンジンWebSocket接続が失われました。",
  "daemon.stateConnected": "エンジン",
  "daemon.stateConnecting": "接続中",
  "daemon.stateError": "エラー",
  "daemon.stateDisconnected": "オフライン",
  "daemon.titlePrefix": "エンジン",
  "daemon.notConnectedWarning": "エンジンが接続されていません。キャリブレーションデータは記録されません。",
  "daemon.auth": "認証 ✓",
  ...
  "daemon.restart": "再起動",
  "daemon.restartTitle": "クリックしてエンジンを再起動",
  "daemon.stateChangeConnected": "エンジンが再接続されました。",
  "daemon.stateChangeDisconnected": "エンジンが切断されました — 再接続中…",
  "daemon.popoverTitle": "エンジンステータス",
  "daemon.uptime": "稼働時間",
