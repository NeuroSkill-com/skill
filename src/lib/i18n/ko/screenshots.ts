...
const screenshots: Record<string, string> = {
  ...
  "screenshots.backendRlx": "RLX (로컬, safetensors)",
  ...
  "screenshots.ocrEngineOcrs": "rlx-ocr — 로컬 CPU / GPU (크로스 플랫폼)",
  "screenshots.ocrAppleVisionHint": "⚡ Apple Vision은 GPU/ANE에서 실행되며 macOS에서 rlx-ocr보다 빠릅니다",
  ...
  "screenshots.ocrDesc":
    "rlx-ocr 엔진을 사용하여 다운사이징 전 전체 해상도에서 각 스크린샷의 텍스트를 추출합니다. 추출된 텍스트는 nomic-embed-text-v1.5로 임베딩되고 시맨틱 텍스트 검색을 위해 별도의 HNSW 인덱스에 인덱싱됩니다. OCR 모델은 번들로 제공되어 오프라인에서 실행되며 다운로드가 필요하지 않습니다.",
