...
const settings: Record<string, string> = {
  ...
  "settings.inferenceDeviceAutoDesc": "Apple Silicon에서 MLX, 그 외에는 GPU.",
  "settings.inferenceDeviceMlx": "MLX",
  "settings.inferenceDeviceMlxDesc": "Apple Silicon 네이티브 — Mac에서 가장 빠름.",
  "settings.inferenceDeviceGpu": "GPU",
  "settings.inferenceDeviceCpu": "CPU",
  "settings.inferenceDeviceGpuDesc": "wgpu (Metal / Vulkan)로 추론.",
  ...
  "activity.todaySummary": "오늘의 활동",
  "activity.filesWorked": "파일",
  "activity.edits": "편집",
  "activity.linesChanged": "변경된 줄",
  "activity.projects": "프로젝트",
  "activity.noData": "오늘 기록된 파일 활동이 없습니다.",
  "activity.productivityScore": "생산성 점수",
  "activity.editVelocity": "편집 속도",
  "activity.deepWork": "딥 워크",
  "activity.contextStability": "컨텍스트 안정성",
  "activity.eegFocus": "EEG 집중도",
  "activity.hourlyHeatmap": "시간별 활동",
  "activity.topFiles": "상위 파일",
  "activity.topProjects": "상위 프로젝트",
  "activity.last7days": "최근 7일",
  "activity.languages": "언어",
  "activity.focusSessions": "집중 세션",
  "activity.filesShort": "파일",
  "activity.meetings": "회의",
  ...
  "activity.noFlow": "플로우 아님",
  "activity.fatiguedTitle": "집중력 저하",
  "activity.streakDays": "일 연속",
  "activity.todayLabel": "오늘",
  "activity.timeline": "타임라인",
  "activity.codeBrain": "코드-뇌 상관관계",
  "activity.brainByLanguage": "언어별 집중도",
  "activity.bestFiles": "최고 집중도",
  "activity.worstFiles": "최저 집중도",
  ...
  "umapSettings.precision": "정밀도",
  "umapSettings.precisionDesc":
    "부동소수점 정밀도. F16(반정밀도)은 더 빠르고 메모리를 적게 사용하며, F32(단정밀도)는 더 정확합니다.",
  ...
  "daemon.connection": "엔진",
  "daemon.unreachable": "엔진에 접근할 수 없음: {error}. 일부 기능을 사용할 수 없습니다.",
  "daemon.authFailed": "엔진 인증 실패. 토큰이 새로고침되었을 수 있습니다.",
  "daemon.wsError": "엔진 WebSocket 연결이 끊어졌습니다.",
  "daemon.stateConnected": "엔진",
  "daemon.stateConnecting": "연결 중",
  "daemon.stateError": "오류",
  "daemon.stateDisconnected": "오프라인",
  "daemon.titlePrefix": "엔진",
  "daemon.notConnectedWarning": "엔진이 연결되지 않았습니다. 캘리브레이션 데이터가 기록되지 않습니다.",
  "daemon.auth": "인증 ✓",
  ...
  "daemon.restart": "재시작",
  "daemon.restartTitle": "클릭하여 엔진 재시작",
  "daemon.stateChangeConnected": "엔진이 다시 연결되었습니다.",
  "daemon.stateChangeDisconnected": "엔진 연결 끊김 — 다시 연결 중…",
  "daemon.popoverTitle": "엔진 상태",
  "daemon.uptime": "가동 시간",
  "daemon.version": "버전",
  "daemon.latency": "지연 시간",
  "daemon.wsClients": "WS 클라이언트",
  "daemon.forceRestart": "강제 재시작",
  "daemon.streaming": "스트리밍 중",
  "daemon.idle": "대기 중",
