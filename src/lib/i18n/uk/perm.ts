...
const perm: Record<string, string> = {
  ...
  "perm.locationOk":
    "Дозвіл на місцезнаходження надано. CoreLocation буде використовуватися для точного місцезнаходження.",
  "perm.locationFallback":
    "Місцезнаходження не авторизовано — застосунок використовуватиме IP-геолокацію (точність на рівні міста).",
