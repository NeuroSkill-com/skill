...
const perm: Record<string, string> = {
  ...
  "perm.screenRecordingDesc": "נדרש ללכידת חלונות יישומים אחרים עבור מערכת הטמעת צילומי מסך. macOS מסתיר תוכן חלונות ללא הרשאה זו.",
  ...
  "perm.whyScreenRecordingDesc": "ללכידת החלון הפעיל לחיפוש דמיון חזותי וקורלציית EEG חוצת-מודאליות. רק צילומי מסך שנבחרו נשמרים — אף פעם לא הקלטה רציפה.",
