...
const settings: Record<string, string> = {
  ...
  "settings.inferenceDeviceAuto": "אוטומטי",
  "settings.inferenceDeviceAutoDesc": "MLX ב-Apple Silicon, GPU במקומות אחרים.",
  "settings.inferenceDeviceMlx": "MLX",
  "settings.inferenceDeviceMlxDesc": "טבעי ל-Apple Silicon — הכי מהיר ב-Mac.",
  "settings.inferenceDeviceGpu": "GPU",
  "settings.inferenceDeviceCpu": "CPU",
  "settings.inferenceDeviceGpuDesc": "משתמש ב-wgpu (Metal / Vulkan) להסקה.",
  ...
  "activity.todaySummary": "פעילות היום",
  "activity.filesWorked": "קבצים",
  "activity.edits": "עריכות",
  "activity.linesChanged": "שורות ששונו",
  "activity.projects": "פרויקטים",
  "activity.noData": "לא נרשמה פעילות קבצים היום.",
  "activity.productivityScore": "ציון פרודוקטיביות",
  "activity.editVelocity": "מהירות עריכה",
  "activity.deepWork": "עבודה עמוקה",
  "activity.contextStability": "יציבות הקשר",
  "activity.eegFocus": "מיקוד EEG",
  "activity.hourlyHeatmap": "פעילות שעתית",
  "activity.topFiles": "קבצים מובילים",
  "activity.topProjects": "פרויקטים מובילים",
  "activity.last7days": "7 ימים אחרונים",
  "activity.languages": "שפות",
  "activity.focusSessions": "הפעלות מיקוד",
  "activity.filesShort": "קבצים",
  "activity.meetings": "פגישות",
  ...
  "activity.noFlow": "לא בזרימה",
  "activity.fatiguedTitle": "מיקוד יורד",
  "activity.streakDays": "ימי רצף",
  "activity.todayLabel": "היום",
  "activity.timeline": "ציר זמן",
  "activity.codeBrain": "מתאם קוד-מוח",
  "activity.brainByLanguage": "מיקוד לפי שפה",
  "activity.bestFiles": "מיקוד הטוב ביותר",
  "activity.worstFiles": "מיקוד הנמוך ביותר",
  ...
  "umapSettings.precision": "דיוק",
  "umapSettings.precisionDesc": "דיוק נקודה צפה. F16 (חצי) מהיר יותר וצורך פחות זיכרון; F32 (מלא) מדויק יותר.",
  ...
  "settings.supportedDevices.instruction.antneuro1":
    "חברו את מגבר ה-eego דרך USB-C. לא נדרש SDK של היצרן — USB מקורי משמש באופן אוטומטי.",
  "settings.supportedDevices.instruction.antneuro2": "הסורק מזהה אוטומטית מגברי eego. בחרו מרשימת המכשירים והתחברו.",
  ...
  "daemon.connection": "מנוע",
  "daemon.unreachable": "לא ניתן להתחבר למנוע: {error}. חלק מהתכונות עשויות להיות לא זמינות.",
  "daemon.authFailed": "אימות המנוע נכשל.",
  "daemon.wsError": "חיבור WebSocket של המנוע אבד.",
  "daemon.stateConnected": "מנוע",
  "daemon.stateConnecting": "מתחבר",
  "daemon.stateError": "שגיאה",
  "daemon.stateDisconnected": "לא מקוון",
  "daemon.titlePrefix": "מנוע",
  "daemon.notConnectedWarning": "המנוע לא מחובר. נתוני כיול לא יוקלטו.",
  "daemon.auth": "auth ✓",
  ...
  "daemon.restart": "הפעל מחדש",
  "daemon.restartTitle": "לחץ להפעלה מחדש של המנוע",
  "daemon.stateChangeConnected": "המנוע התחבר מחדש.",
  "daemon.stateChangeDisconnected": "המנוע התנתק — מתחבר מחדש…",
  "daemon.popoverTitle": "סטטוס מנוע",
  "daemon.uptime": "זמן פעילות",
  "daemon.version": "גרסה",
