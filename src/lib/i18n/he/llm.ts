...
const llm: Record<string, string> = {
  ...
  "llm.hfSearch.addBtn": "הוספה",
  "llm.hfSearch.addDownloadBtn": "הוספה והורדה",
  "llm.hfSearch.openInBrowser": "פתח ב-HuggingFace",
  ...
  "chat.loading.model": "טוען משקלי מודל",
  "chat.loading.context": "יוצר הקשר",
  "chat.loading.vision": "טוען מקרן ראייה",
  "chat.loading.warmup": "מקמפל שיידרים של GPU",
  "chat.thinking": "חושב…",
  "chat.thought": "מחשבה",
  ...
  "chat.inputPlaceholderNoEeg": "חבר אוזנייות תחילה",
  ...
  "chat.hint.noEeg": "חבר אוזנייות כדי להתחיל לשוחח",
  "chat.eeg.label": "EEG",
  "chat.eeg.on": "הקשר EEG פעיל — מצב המוח ייכלל בכל בקשה",
  "chat.eeg.off": "הקשר EEG כבוי — לחץ להפעלה",
  "chat.eeg.noSignal": "אין אות EEG",
  "chat.eeg.noSignalBlockedHint": "אין אות EEG — חבר אוזנייות כדי להתחיל לשוחח",
  ...
  "llm.tools.dateHint":
    "נותן למודל מודעות לתאריך, שעה, חותמת Unix ואזור זמן נוכחיים. שימושי לשאלות תלויות זמן. שום מידע לא עוזב את המחשב שלך.",
  "llm.tools.locationHint":
    "מבצע בדיקת מיקום לפי IP כדי לקבוע מדינה, אזור, עיר ואזור זמן. כתובת ה-IP שלך נשלחת לשירות הגיאולוקציה.",
  ...
  "llm.tools.bashHint":
    "מאפשר למודל להריץ פקודות מעטפת ישירות על המחשב שלך. בדיקת בטיחות חוסמת פקודות הרסניות ברורות, אך למודל יש את אותן הרשאות כמו חשבון המשתמש שלך.",
  "llm.tools.readFileHint":
    "מאפשר למודל לקרוא כל קובץ טקסט שחשבון המשתמש שלך יכול לגשת אליו. קבצים גדולים מחולקים לדפים.",
  ...
  "llm.tools.advancedHint":
    "כלים מתקדמים מסומנים בכתום כי הם מעניקים למודל גישה ישירה למערכת הקבצים או למעטפת שלך. הפעל רק אם אתה סומך על המודל.",
  "llm.tools.skillApi": "Skill API",
  "llm.tools.skillApiDesc":
    "הרשה ל-LLM לשלוח שאילתות ל-API של NeuroSkill — מצב מכשיר, הקלטות EEG, תוויות, חיפוש, הוקים, כיולים, TTS ועוד.",
  ...
  "llm.tools.contextCompressionDesc":
    "דחיסת תוצאות כלים כדי לחסוך מקום בחלון ההקשר. מומלץ למודלים קטנים (< 8K הקשר). עוזר למודל להשלים שרשראות כלים מרובות שלבים (למשל חיפוש ואז שליפה).",
  "llm.tools.compressionOff": "כבוי",
  "llm.tools.compressionNormal": "רגיל",
  "llm.tools.compressionAggressive": "אגרסיבי",
  "chat.tools.thinkingBudget": "תקציב חשיבה לכלים",
  ...
  "llm.tools.retrySection": "ניסיון חוזר ברשת",
  "llm.tools.retrySectionDesc": "ניסיון חוזר של כלי רשת (חיפוש, אחזור, מיקום) בשגיאות זמניות עם השהייה מעריכית.",
  "llm.tools.retryMaxRetries": "מקסימום ניסיונות",
  "llm.tools.retryMaxRetriesDesc": "מספר ניסיונות חוזרים לאחר הכישלון הראשון. 0 = ללא ניסיון חוזר.",
  "llm.tools.retryBaseDelay": "השהייה בסיסית",
  "llm.tools.retryBaseDelayDesc": "השהייה ראשונית באלפיות שנייה לפני הניסיון החוזר הראשון. מוכפלת בכל ניסיון.",
  "llm.tools.retryMs": "ms",
  "llm.tools.webCache": "מטמון רשת",
  "llm.tools.webCacheDesc": "שמירת תוצאות חיפוש ואחזור רשת על הדיסק.",
  "llm.tools.webCacheEntries": "{n} רשומות",
  "llm.tools.webCacheSize": "{size}",
  "llm.tools.webCacheEmpty": "המטמון ריק",
  "llm.tools.webCacheClearAll": "נקה הכל",
  "llm.tools.webCacheRemoveDomain": "הסר דומיין",
  "llm.tools.webCacheRemoveEntry": "הסר",
  "llm.tools.webCacheSearch": "חיפוש",
  "llm.tools.webCacheFetch": "אחזור",
  "llm.tools.webCacheSearchTtl": "TTL חיפוש",
  "llm.tools.webCacheFetchTtl": "TTL אחזור",
  "llm.tools.webCacheTtlMin": "דק'",
  "llm.tools.webCacheCleared": "{n} רשומות נמחקו",
  ...
  "llm.tools.skillsSection": "יכולות הסוכן",
  ...
  "chat.tts.manualWeightsHint": "מנוע זה דורש משקולות מקומיות (ללא הורדה אוטומטית).",
  ...
  "chat.voice.engineExperimental": "מנוע זיהוי זה עשוי להוריד צ'קפוינט גדול בשימוש הראשון.",
