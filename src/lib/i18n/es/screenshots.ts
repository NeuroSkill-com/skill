...
const screenshots: Record<string, string> = {
  ...
  "screenshots.ocrEngineOcrs": "rlx-ocr — CPU / GPU local (multiplataforma)",
  "screenshots.ocrAppleVisionHint": "⚡ Apple Vision se ejecuta en GPU/ANE y es más rápido que rlx-ocr en macOS",
  ...
  "screenshots.ocrDesc":
    "El texto se extrae de cada captura de pantalla en resolución completa antes de reducirla utilizando el motor rlx-ocr. El texto extraído se incrusta con nomic-embed-text-v1.5 y se indexa en un índice HNSW separado para la búsqueda de texto semántico. Los modelos de OCR están incluidos y se ejecutan sin conexión: no se requiere descarga.",
