...
const ui: Record<string, string> = {
  ...
  "cmdK.sectionTerminal": "Terminal",
  "cmdK.terminalCommands": "Comandos recientes de terminal",
  "cmdK.terminalImpact": "Impacto del enfoque en terminal",
  "cmdK.contextCost": "Costo de cambio de contexto",
  "cmdK.devLoops": "Ciclos de desarrollo",
  ...
  "about.tagline":
    "Sistema EXG State of Mind en tiempo real y monitorización del estado cerebral para Muse, OpenBCI, Emotiv, IDUN y otros dispositivos BCI.",
  "about.copyright": "© 2025–2026 NeuroSkill.com",
  "about.role.eugene": "Desarrollador principal y procesamiento de señales EEG",
  "about.role.nataliya": "Neurociencia e interfaces cerebro-computadora",
  "about.ack":
    "Creado con Tauri, SvelteKit y el modelo fundacional ZUNA EEG de Zyphra. Investigación de potencia de bandas EEG basada en trabajos de Klimesch (1999), Pope et al. (1995) y Kosmyna & Maes (2019).",
  ...
  "devices.virtualDevices": "Simulado",
  ...
  "alerts.deviceGeneric": "Dispositivo",
  "alerts.lowBatteryTitle": "Batería baja",
  "alerts.lowBatteryBody": "La batería de {name} está al {pct}%.",
  "alerts.signalDroppedTitle": "La calidad de la señal bajó",
  "alerts.signalDroppedBody": "La señal EEG empeoró durante la grabación. Recoloca los electrodos / ajusta el casco.",

  "devices.iosOnly": "solo vía iOS",
  ...
  "cmdK.sectionSettings": "Configuración",

  // ── Auto-synced from en/ (2026-04-28) ──
  "updates.receivePrereleases": "Recibir versiones preliminares",
