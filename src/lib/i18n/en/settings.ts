...
const settings: Record<string, string> = {
  ...
  "settings.supportedDevices.instruction.antneuro1": "Connect your eego amplifier via USB.",
  "settings.supportedDevices.instruction.antneuro2":
    "The scanner auto-detects eego amplifiers. Select from the device list and connect. Configure cap layout in Device API settings if needed.",
  ...
  "settings.deviceApi.neurosityDesc": "Credentials and device id for Neurosity Crown/Notion cloud streaming.",
  "settings.deviceApi.neurosityEmail": "Email",
  "settings.deviceApi.neurosityPassword": "Password",
  "settings.deviceApi.neurosityDeviceId": "Device ID",
  "settings.deviceApi.brainmasterTitle": "BrainMaster",
  "settings.deviceApi.brainmasterDesc": "Select the BrainMaster model used by the connector.",
  "settings.deviceApi.brainmasterModel": "Model",
  ...
  "settings.shortcutCompare": "Compare",
  ...
  "settings.logIroh": "Iroh Networking",
  "settings.logIrohDesc": "Relay, QUIC, IPv6 warnings (daemon — very noisy)",
  ...
  "settingsTabs.activity": "Activity",
  ...
  "activity.filesWorked": "Files",
  "activity.edits": "Edits",
  "activity.linesChanged": "Lines changed",
  "activity.projects": "Projects",
  "activity.noData": "No file activity recorded today.",
  "activity.productivityScore": "Productivity Score",
  "activity.editVelocity": "Edit velocity",
  "activity.deepWork": "Deep work",
  "activity.contextStability": "Context stability",
  "activity.eegFocus": "EEG focus",
  "activity.hourlyHeatmap": "Hourly Activity",
  "activity.topFiles": "Top Files",
  "activity.topProjects": "Top Projects",
  "activity.last7days": "Last 7 days",
  "activity.languages": "Languages",
  "activity.focusSessions": "Focus Sessions",
  "activity.filesShort": "files",
  ...
  "tokens.desc": "Manage API tokens for daemon access. Each token has a name, access level, and expiration.",
  ...
  "tokens.aclAdminDesc": "Full access — all endpoints",
  ...
  "daemon.unreachable": "Unable to reach the engine: {error}. Some features may be unavailable.",
  "daemon.authFailed": "Engine authentication failed. Token may have been refreshed.",
  "daemon.wsError": "Engine WebSocket connection lost.",
  ...
  "daemon.notConnectedWarning": "Engine is not connected. Calibration data will not be recorded.",
  "daemon.auth": "auth ✓",
  ...
  "daemon.restartTitle": "Click to restart the engine",
  "daemon.stateChangeConnected": "Engine reconnected.",
  "daemon.stateChangeDisconnected": "Engine disconnected — reconnecting…",
  ...
  "extensions.chromeDesc": "Tab activity, reading patterns, scroll depth, and search behavior.",
  "extensions.firefox": "Firefox",
  "extensions.firefoxDesc": "Tab activity, reading patterns, scroll depth, and search behavior.",
  "extensions.edge": "Microsoft Edge",
  "extensions.edgeDesc": "Tab activity, reading patterns, scroll depth, and search behavior. (Uses the Chrome build.)",
  "extensions.allowUnsigned": "Allow Unsigned",
  "extensions.safari": "Safari",
  "extensions.safariDesc": "Tab activity, reading patterns, scroll depth, and search behavior.",
  ...
  "extensions.copyToken": "Copy Auth Token",
  "extensions.tokenCopied": "Token copied to clipboard",
  "extensions.tokenFailed": "Could not copy token",
  "extensions.pairViaBrowser": "Pair in Browser",
  "extensions.pairViaBrowserHint": "Opens a pairing page in your default browser",
  "extensions.copyTokenHint": "Manual — paste in extension settings",
  "extensions.pairingOpened": "Pairing page opened — the extension will connect automatically",
  "extensions.pairingFailed": "Could not generate pairing link",
  "extensions.pairingInProgress": "Opening...",
  "extensions.copyPairingToken": "Copy Pairing Token",
  "extensions.copyPairingTokenHint": "Recommended: open extension popup → auto-pairs from clipboard",
  "extensions.clipboardPairCopied": "Token copied. Open the extension popup — it will pair automatically.",

  // ── Browser activity analytics ────────────────────────────────────────
  "activity.browserTitle": "Browser Activity",
  "activity.browserFocus": "Focus by Domain",
  "activity.browserDistraction": "Distraction Score",
  "activity.browserContent": "Content Breakdown",
  "activity.browserResearch": "Research Patterns",
  "activity.browserLlm": "AI Chat Usage",
  "activity.browserDomains": "Top Domains",
  "activity.browserNoData": "No browser data yet — install the browser extension to start tracking.",
  "activity.distractionLow": "Focused",
  "activity.distractionMedium": "Moderate",
  "activity.distractionHigh": "Distracted",
  "activity.searches": "searches",
  "activity.refinementRate": "refinement rate",
  "activity.revisits": "revisits",
  "activity.stuck": "Possibly stuck",
  "activity.notStuck": "Productive research",
  "activity.tabSwitchesPerMin": "tab switches/min",
  "activity.socialPct": "social %",
  "activity.productivePct": "productive %",
  "activity.totalReadingTime": "reading time",
  "activity.avgScrollDepth": "avg scroll depth",
