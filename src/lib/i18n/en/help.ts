...
const help: Record<string, string> = {
  ...
  "helpDash.statusHeroBody":     "The top card shows the live connection state of your BCI device. A coloured ring and badge indicate whether the device is disconnected, scanning, connected, or if Bluetooth is off. When connected, the device name, serial number, and MAC address are shown (click to reveal/hide).",
  ...
  "helpSettings.openbciSectionDesc":    "Connect and configure any OpenBCI board — Ganglion, Cyton, Cyton+Daisy, WiFi Shield variants, or Galea — standalone or alongside another BCI device.",
  ...
  "helpPrivacy.bleBody":            "{app} communicates with your BCI device over Bluetooth Low Energy or USB serial. The connection uses the standard CoreBluetooth (macOS) or BlueZ (Linux) system stack. No custom Bluetooth drivers or kernel modules are installed.",
