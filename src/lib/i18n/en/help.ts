...
const help: Record<string, string> = {
  ...
  "helpDash.trayAmberDesc": "Searching for a BCI device or attempting to connect.",
  ...
  "helpOld.hooksDesc":
    "Hooks listen in the background: fuzzy keyword match → text-neighbor expansion → EEG-distance check. If matched, the app broadcasts a hook event and shows a notification.",
  ...
  "helpOld.trayIconDesc":
    "The menu-bar icon changes colour and shape to reflect the current connection state at a glance.",
  ...
  "helpOld.btLifecycleDesc":
    "{app} monitors Bluetooth state in real time using CoreBluetooth (macOS) or BlueZ (Linux). No polling delay — state changes are reflected within one second.",
  "helpOld.btStep1": "Bluetooth turns off",
  "helpOld.btStep1Desc":
    "The tray icon turns red instantly. The Bluetooth-Off card replaces the main view. No scanning or connection attempt is made.",
  "helpOld.btStep2": "Bluetooth turns back on",
  "helpOld.btStep2Desc":
    "Within ~1 second, {app} resumes scanning automatically. If a preferred device was previously paired, a connection attempt starts.",
  "helpOld.btStep3": "BCI device is powered on",
  "helpOld.btStep3Desc":
    "The background scanner discovers it within 3–6 seconds and connects automatically; the icon turns green.",
  "helpOld.btStep4": "Device not found immediately",
  "helpOld.btStep4Desc":
    "{app} retries silently every 3 seconds. The spinner stays visible until the device is found or you cancel manually.",
  "helpOld.btStep5": "You click Retry",
  "helpOld.btStep5Desc":
    "Same auto-retry loop as automatic reconnect. Retries every 3 seconds until the device is found.",
  ...
  "helpOld.wsDesc":
    "{app} streams derived EEG metrics (~4 Hz band powers, scores, heart rate) and device status (~1 Hz) over a local WebSocket server. Raw EEG/PPG/IMU samples are not broadcast. The service is advertised via Bonjour / mDNS so clients can discover it without knowing the IP address.",
  ...
  "helpFaq.q44": "Can I use two BCI devices at the same time?",
  "helpFaq.a44":
