...
const onboarding: Record<string, string> = {
  ...
  "onboarding.welcomeBody":       "{app} records, analyzes, and indexes your EEG data from any supported BCI device. Let's get you set up in a few quick steps.",
  ...
  "onboarding.bluetoothBody":     "Turn on your BCI device and wear it. {app} will scan for nearby devices and connect automatically.",
  ...
  "onboarding.btStep1":           "Turn on your BCI device (hold the power button, flip the switch, or press the button depending on your headset).",
