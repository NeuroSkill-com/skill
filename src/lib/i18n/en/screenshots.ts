...
const screenshots: Record<string, string> = {
  ...
  "screenshots.ocrDesc":
    "Text is extracted from each screenshot at full resolution before downsizing using the ocrs engine. The extracted text is embedded with BGE-Small-EN-v1.5 and indexed in a separate HNSW index for semantic text search. OCR models (~10 MB each) are downloaded automatically on first use.",
