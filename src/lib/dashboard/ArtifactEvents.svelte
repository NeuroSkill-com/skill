...
<CollapsibleSection title={t("dashboard.artifacts")} dotColor="text-pink-500">
  <div class="grid grid-cols-2 gap-x-2 gap-y-1.5">
    <MetricTooltip text={t("tip.blinks")}>
      <div class="flex flex-col gap-0.5">
        <div class="flex items-center justify-between">
          <span class="text-ui-2xs font-medium text-muted-foreground uppercase tracking-wider">{t("dashboard.blinks")}</span>
    ...
    <MetricTooltip text={t("tip.blinkRate")}>
      <div class="flex flex-col gap-0.5">
        <div class="flex items-center justify-between">
          <span class="text-ui-2xs font-medium text-muted-foreground uppercase tracking-wider">{t("dashboard.blinkRate")}</span>
