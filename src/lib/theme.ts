 ...
 */
export function colorForLoad(ratio: number, warnAt = 0.50, badAt = 0.80): string {
...
export const STATE_COLORS = {
  connected:    { ring: C_GOOD,    badge: rgba(C_GOOD, .15),   text: C_GOOD,    border: rgba(C_GOOD, .35)   },
  scanning:     { ring: C_WARN,    badge: rgba(C_WARN, .13),   text: C_WARN,    border: rgba(C_WARN, .32)   },
  bt_off:       { ring: C_BAD,     badge: rgba(C_BAD,  .13),   text: C_BAD,     border: rgba(C_BAD,  .32)   },
