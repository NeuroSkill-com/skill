...
{#if open}
  <div
    ...
    <div class="flex items-center justify-between gap-2
                ...
                bg-slate-50/80 dark:bg-surface-3 shrink-0">
      ...
      {#each CATEGORIES as cat}
        <section>
          ...
          <div class="flex items-center gap-1.5 mb-1.5">
            ...
            <span class="text-ui-sm font-semibold uppercase tracking-widest
          ...
          <div class="flex flex-wrap gap-1.5">
            {#each cat.prompts as prompt}
              <button
                onclick={() => pick(prompt)}
                class="px-2.5 py-1 rounded-lg text-ui-base text-left leading-snug
    ...
    <div class="shrink-0 px-4 py-1.5
                ...
                bg-slate-50/50 dark:bg-surface-3">
      <p class="text-ui-xs text-muted-foreground/40 text-center">
        {t("chat.prompts.hint")}
      </p>
    </div>
  </div>
