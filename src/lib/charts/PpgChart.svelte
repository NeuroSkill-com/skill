  ...
  <div class="flex items-center gap-3 flex-wrap">
    {#each CH as label, i}
      <div class="flex items-center gap-1.5">
        ...
        <span class="text-ui-xs font-semibold text-muted-foreground">{label}</span>
        <span class="font-mono text-ui-sm text-muted-foreground/70 tabular-nums">
    ...
    {#if ppgTooltip}
      ...
      <div
        class="absolute z-10 pointer-events-auto rounded-md px-2.5 py-1.5
               ...
               text-ui-base font-semibold leading-snug max-w-[220px] break-words
               bg-[#1a1a2e]/90"
