...
{#if gpuStats !== null}
  ...
  >
    <!-- Label -->
    <span class="text-ui-xs font-semibold tracking-widest uppercase text-muted-foreground/70 leading-none">
      GPU
    </span>
    ...
    <!-- Percentage -->
    <span class="text-ui-sm tabular-nums leading-none" style="color:{col}">
