...
## הטמעות טקסט
תוויות ושאילתות חיפוש מוטמעות באמצעות nomic-embed-text-v1.5 (מודל ONNX בנפח ~130 MB, 768 ממדים). המודל מורד פעם אחת מ-HuggingFace Hub ונשמר מקומית. הוא מניע הן את חיפוש דמיון הטקסט והן את אינדקס התוויות הסמנטי המשמש את Proactive Hooks.
...
# לשונית מודל EEG
ניטור מקודד הטמעת ה-EEG ומצב אינדקס הוקטורים HNSW.

## מצב מקודד
מציג אם מקודד הטמעת ה-EEG נטען, סיכום הארכיטקטורה (ממד, שכבות, ראשים), והנתיב לקובץ המשקלות .safetensors. המקודד רץ לחלוטין על המכשיר באמצעות ה-GPU שלך.
