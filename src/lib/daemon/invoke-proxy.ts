...
const ROUTES: Record<string, [typeof G | typeof P, string]> = {
  ...
  get_label_index_backend: [G, "/v1/labels/index/backend"],
  set_label_index_backend: [P, "/v1/labels/index/backend"],
  get_label_index_stats: [G, "/v1/labels/index/stats"],
  benchmark_label_index: [P, "/v1/labels/index/benchmark"],
