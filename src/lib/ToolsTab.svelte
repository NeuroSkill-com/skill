...
<section>
  <a href="https://discord.gg/Rcvb8Cx4cZ" target="_blank" rel="noopener noreferrer"
     class="flex items-center gap-3 rounded-xl border border-primary/20 bg-primary/[0.05]
            hover:bg-primary/[0.10] transition-colors px-4 py-3 group cursor-pointer no-underline">
    ...
    <div class="flex flex-col gap-0.5">
      ...
      <span class="text-[0.6rem] text-muted-foreground leading-relaxed">
        {t("llm.tools.suggestSkillDesc")}
      </span>
    </div>
    <svg class="w-4 h-4 text-primary/50 ml-auto shrink-0" viewBox="0 0 24 24" fill="none"
