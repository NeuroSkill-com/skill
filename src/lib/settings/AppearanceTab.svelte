...
<section class="flex flex-col gap-2">
  <SectionHeader>{t("settings.fontSize")}</SectionHeader>
  ...
  <SettingsCard>
    <CardContent class="flex flex-col gap-3 px-4 py-3.5">
      ...
      <ChipGroup
        ...
        selected={FONT_SIZE_PRESETS.find(p => p.value === getFontSize()) ?? FONT_SIZE_PRESETS[0]}
        onselect={(preset) => setFontSize(preset.value)}
        labelFn={(preset) => `${preset.label} · ${preset.value}%`}
      />
    </CardContent>
  </SettingsCard>
</section>
...
<!-- ── Theme ──────────────────────────────────────────────────────────────── -->
<section class="flex flex-col gap-2">
  <SectionHeader>{t("appearance.theme")}</SectionHeader>
  ...
  <SettingsCard>
    <CardContent class="flex flex-col divide-y divide-border dark:divide-white/[0.05] py-0 px-0">
      ...
      <div class="flex flex-col gap-2.5 px-4 py-3.5">
        <span class="text-ui-lg font-semibold text-foreground">{t("appearance.colorMode")}</span>
...
<!-- ── Accent colour ──────────────────────────────────────────────────────── -->
<section class="flex flex-col gap-2">
  <SectionHeader>{t("appearance.accentColor")}</SectionHeader>
      ...
      <div class="flex flex-wrap gap-2.5">
        {#each ACCENT_PRESETS as preset}
          ...
          <button
            ...
            <!-- Label -->
            <span class="text-ui-xs font-medium leading-none
...
<!-- ── Chart Color Scheme ─────────────────────────────────────────────────── -->
<section class="flex flex-col gap-2">
  <SectionHeader>{t("appearance.chartColors")}</SectionHeader>
        ...
        {#each CHART_SCHEMES as scheme (scheme.id)}
          <button
            ...
            <div class="flex flex-col gap-0.5 min-w-0 flex-1">
              <span class="text-ui-md font-semibold leading-tight
                           {getChartScheme() === scheme.id ? 'text-violet-600 dark:text-violet-400' : 'text-foreground'}">
                {t(scheme.labelKey)}
              </span>
            ...
            {#if getChartScheme() === scheme.id}
              <span class="text-ui-xs font-bold tracking-widest uppercase text-violet-500 shrink-0">
                {t("common.active")}
              </span>
            {/if}
          </button>
